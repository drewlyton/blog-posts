...
Employing this tactic has helped me avoid banging my head against my computer for days on end countless times. The constant practice of explaining bugs and issues has also made me faster at triaging them. I'm calmer when problems arise, and it's easier to see patterns and link the current problem to another I've seen before. 

Rubber ducking has been such a game-changer that I actually created what I call a *Rubber Ducking Doc*. This is a single page template with questions that prompt me to step through the process of communicating the issue at hand.
