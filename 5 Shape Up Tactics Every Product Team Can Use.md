...
## 3. The Pitch
One of the biggest liabilities to a product team is a *bias towards building*. Jumping from ideation to execution without mitigating risks from untested assumptions can lead to an extreme amount of waste. This bias usually presents itself on teams with heavy engineering backgrounds. 
