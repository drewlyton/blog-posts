...
So, a one hour meeting with 5 attendees costs 5 hours of time. However, this function only calculates the cost of *active* meeting time. It doesn't take into account the large amount of *inactive* time the meeting creates.
